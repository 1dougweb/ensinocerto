<?php $__env->startSection('title', 'Templates de Contratos'); ?>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.contracts.templates.create')); ?>" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <?php if(!$aiConfigured): ?>
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <a href="<?php echo e(route('admin.settings.index')); ?>#chatgpt-tab" class="alert-link">configure a API key do ChatGPT</a> 
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body text-center">
                                    <h4 class="mb-1"><?php echo e($templates->total()); ?></h4>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    <h4 class="mb-1"><?php echo e($templates->where('is_active', true)->count()); ?></h4>
                                    <small>Ativos</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body text-center">
                                    <h4 class="mb-1"><?php echo e($templates->where('is_default', true)->count()); ?></h4>
                                    <small>Padrão</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body text-center">
                                    <h4 class="mb-1"><?php echo e($templates->sum('contracts_count')); ?></h4>
                    ...
                    <div class="row">
                        <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card h-100 <?php echo e($template->is_default ? 'border-warning' : ($template->is_active ? 'border-success' : 'border-secondary')); ?>">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center mb-3">
                                            <div class="col-6">
                                                <h6 class="mb-0"><?php echo e($template->contracts_count); ?></h6>
                                                <small class="text-muted">Contratos</small>
                                            </div>
                                            <div class="col-6">
                                                <h6 class="mb-0"><?php echo e($template->validity_days); ?></h6>
                                        ...
                                        <div class="text-muted small mb-3">
                                            ...
                                            Criado em <?php echo e($template->created_at->format('d/m/Y')); ?>

                                            <?php if($template->creator): ?>
                                                por <?php echo e($template->creator->name); ?>
                                    ...
                                    <div class="card-footer">
                                        <div class="btn-group w-100" role="group">
                                            <a href="<?php echo e(route('admin.contracts.templates.show', $template)); ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.contracts.templates.preview', $template)); ?>" class="btn btn-sm btn-outline-info" target="_blank">
                                                <i class="fas fa-search"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.contracts.templates.edit', $template)); ?>" class="btn btn-sm btn-outline-warning">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <?php if(!$template->is_default): ?>
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="setDefault(<?php echo e($template->id); ?>)">
                                                    ...
                                                    <?php endif; ?>
                                                    <li>
                                                        <a class="dropdown-item" href="#" onclick="toggleActive(<?php echo e($template->id); ?>)">
                                                            <i class="fas fa-toggle-<?php echo e($template->is_active ? 'off' : 'on'); ?> me-2"></i>
                                                            <?php echo e($template->is_active ? 'Desativar' : 'Ativar'); ?>

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('admin.contracts.templates.duplicate', $template)); ?>">
                                                    ...
                                                    <?php if($template->contracts_count == 0): ?>
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="#" onclick="deleteTemplate(<?php echo e($template->id); ?>)">
...
function handleFileUpload(input) {
    ...
    fetch('<?php echo e(route("admin.contracts.templates.upload-reference")); ?>', {
        method: 'POST',
        headers: {
...
function generateWithAi() {
    ...
    // Fazer requisição
    fetch('<?php echo e(route("admin.contracts.templates.generate-ai")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            window.location.href = '<?php echo e(route("admin.contracts.templates.create")); ?>?' + params.toString();
        } else {
            ...
            if (data.message && data.message.includes('ChatGPT não está configurado')) {
                if (confirm('⚠️ ChatGPT não está configurado.\n\nDeseja ir para as configurações agora?')) {
                    window.location.href = '<?php echo e(route("admin.settings.index")); ?>#chatgpt-tab';
                }
            } else {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u760830176/domains/ensinocerto.com.br/public_html/resources/views/admin/contracts/templates/index.blade.php ENDPATH**/ ?>