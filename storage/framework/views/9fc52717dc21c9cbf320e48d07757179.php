            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        ...
                        Meus Contatos (<?php echo e($myContacts->count()); ?>)
                    </h5>
                </div>
                <div class="card-body">
                    <?php if($myContacts->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $myContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($contact->name); ?></strong>
                                                <?php if($contact->notes): ?>
                                                    <br>
                                                    <small class="text-muted"><?php echo e(Str::limit($contact->notes, 50)); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="https://wa.me/55<?php echo e($contact->whatsapp); ?>" 
                                                   target="_blank" 
                                                   class="text-success text-decoration-none">
                                                    <i class="fab fa-whatsapp me-1"></i>
                                                    <?php echo e($contact->formatted_whatsapp); ?>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button" 
                                                            ...
                                                            onclick="viewContact(<?php echo e($contact->id); ?>)"
                                                            title="Visualizar">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button type="button" 
                                                            class="btn btn-outline-warning" 
                                                            onclick="editContact(<?php echo e($contact->id); ?>)"
                                                            title="Editar">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        ...
                        Todos os Contatos (<?php echo e($allContacts->count()); ?>)
                    </h5>
                </div>
                <div class="card-body">
                    <?php if($allContacts->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $allContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e($contact->user_id === auth()->id() ? 'table-success' : ''); ?>">
                                            <td>
                                                <strong><?php echo e($contact->name); ?></strong>
                                                <?php if($contact->notes): ?>
                                                    <br>
                                                    <small class="text-muted"><?php echo e(Str::limit($contact->notes, 30)); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="https://wa.me/55<?php echo e($contact->whatsapp); ?>" 
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($contact->user_id === auth()->id() ? 'bg-success' : 'bg-secondary'); ?>">
                                                    <?php echo e($contact->user_id === auth()->id() ? 'Você' : $contact->user->name); ?>
...
<script>
    ...
    document.getElementById('createContactForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("contacts.store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u760830176/domains/ensinocerto.com.br/public_html/resources/views/contacts/index.blade.php ENDPATH**/ ?>