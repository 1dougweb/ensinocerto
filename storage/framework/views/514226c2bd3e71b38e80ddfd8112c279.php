<?php $__env->startSection('title', 'Kanban - Gerenciamento de Leads'); ?>
...
<?php $__env->startSection('page-actions'); ?>
    <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('admin.inscricoes')); ?>" class="btn btn-outline-secondary">
            ...
            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="kanban-column">
                    <div class="card h-100">
                        <div class="card-header bg-<?php echo e($column->color); ?> text-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="mb-0"><?php echo e($column->name); ?></h6>
                                <span class="badge bg-light text-dark">
                                    <?php echo e($kanbanData[$column->slug]->count()); ?>

                                </span>
                            </div>
                        </div>
                        <div class="card-body p-2 kanban-cards scroll-container" data-status="<?php echo e($column->slug); ?>">
                            <?php $__currentLoopData = $kanbanData[$column->slug]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="kanban-card" data-id="<?php echo e($lead->id); ?>" data-status="<?php echo e($lead->etiqueta); ?>" ondblclick="openEditModal(<?php echo e($lead->id); ?>)">
                                    <div class="card mb-2">
                                        <div class="card-body p-3 rounded-3 shadow-lg border" >
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="card-title mb-1" title="<?php echo e($lead->nome); ?>">
                                                        <?php if(strlen($lead->nome) > 30): ?>
                                                            <?php echo e(substr($lead->nome, 0, 27)); ?>...
                                                        <?php else: ?>
                                                            <?php echo e($lead->nome); ?>

                                                        <?php endif; ?>
                                                    </h6>
                                                    <small class="text-muted" title="<?php echo e($lead->email); ?>">
                                                        <?php if(strlen($lead->email) > 25): ?>
                                                            <?php echo e(substr($lead->email, 0, 22)); ?>...
                                                        <?php else: ?>
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-sm btn-outline-secondary dropdown-toggle" 
                                                            type="button" 
                                                            id="dropdownMenuButton<?php echo e($lead->id); ?>"
                                                            data-bs-toggle="dropdown"
                                                            data-bs-auto-close="true"
                                                            aria-expanded="false">
                                                        <i class="fas fa-ellipsis-v"></i>
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton<?php echo e($lead->id); ?>">
                                                        <li>
                                                            <button class="dropdown-item" type="button" onclick="event.stopPropagation(); openEditModal(<?php echo e($lead->id); ?>);">
                                                                <i class="fas fa-edit me-2"></i>Editar Lead
                                                            </button>
                                                        </li>
                                                        <li>
                                                            <button class="dropdown-item" type="button" onclick="event.stopPropagation(); addQuickNote(<?php echo e($lead->id); ?>);">
                                                            <i class="fas fa-sticky-note me-2"></i>Nota Rápida
                                                            </button>
                                                        
                                                        <li>
                                                            <button class="dropdown-item" type="button" onclick="event.stopPropagation(); changeStatus(<?php echo e($lead->id); ?>);">
                                                                <i class="fas fa-exchange-alt me-2"></i>Alterar Status
                                                            </button>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="event.stopPropagation(); window.open('https://wa.me/55<?php echo e(preg_replace('/[^0-9]/', '', $lead->telefone)); ?>', '_blank');">
                                                                <i class="fab fa-whatsapp me-2 text-success"></i>WhatsApp Web
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="event.stopPropagation(); window.open('mailto:<?php echo e($lead->email); ?>', '_blank');">
                                                                <i class="fas fa-envelope me-2 text-primary"></i>Enviar Email
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="event.stopPropagation(); window.open('tel:<?php echo e($lead->telefone); ?>', '_self');">
                                            ...
                                            <div class="mb-2">
                                                <small class="text-muted">
                                                    <i class="fas fa-phone me-1"></i><?php echo e($lead->telefone); ?>

                                                </small>
                                            </div>

                                            <div class="mb-2">
                                                <span class="badge bg-<?php echo e(match($lead->prioridade ?? 'media') { 'baixa' => 'success', 'media' => 'warning', 'alta' => 'orange', 'urgente' => 'danger', default => 'secondary' }); ?>">
                                                    <?php echo e(ucfirst($lead->prioridade ?? 'média')); ?>
                                            ...
                                            <!-- Botões de ação rápida -->
                                                ...
                                                <div class="d-flex gap-1">
                                                    <a href="https://wa.me/55<?php echo e(preg_replace('/[^0-9]/', '', $lead->telefone)); ?>" 
                                                       target="_blank" 
                                                    ...
                                                    <a href="tel:<?php echo e($lead->telefone); ?>" 
                                            ...
                                            <?php if($lead->isLocked()): ?>
                                                <div class="mb-2">
                                                    <small class="text-warning">
                                                        ...
                                                        <?php echo e($lead->locked_by == session('admin_id') ? 'Seu' : ($lead->lockedBy->name ?? 'Usuário')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u760830176/domains/ensinocerto.com.br/public_html/resources/views/admin/kanban/index.blade.php ENDPATH**/ ?>