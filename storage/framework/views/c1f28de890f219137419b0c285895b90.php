...
<body>
    ...
    <div class="content">
        <p>Olá <strong><?php echo e($nome); ?></strong>,</p>
        
        <p>Recebemos sua inscrição com sucesso! Estamos muito felizes em ter você conosco.</p>
        
        <div class="info-box">
            <h3>Detalhes da sua inscrição:</h3>
            <p><strong>Curso:</strong> <?php echo e($curso_label); ?></p>
            <p><strong>Modalidade:</strong> <?php echo e($modalidade_label); ?></p>
            <p><strong>Data da inscrição:</strong> <?php echo e($data); ?></p>
        </div>
...
</html><?php /**PATH /home/u760830176/domains/ensinocerto.com.br/public_html/resources/views/emails/confirmacao.blade.php ENDPATH**/ ?>