...
<body>
    <div class="container">
        ...
        <div class="greeting">
            Olá <strong><?php echo e($matricula->nome_completo); ?></strong>,
        </div>
        ...
        <div class="payment-info">
            ...
            <div class="info-row">
                ...
                <span class="info-value amount"><?php echo e($formattedAmount); ?></span>
            </div>
            
            <div class="info-row">
                <span class="info-label">📅 Data de Vencimento:</span>
                <span class="info-value due-date"><?php echo e($formattedDueDate); ?></span>
            </div>
            
            <div class="info-row">
                <span class="info-label">📝 Descrição:</span>
                <span class="info-value"><?php echo e($payment->descricao); ?></span>
            </div>
            
            <?php if($isParceled): ?>
            <div class="info-row">
                <span class="info-label">🔢 Parcela:</span>
                <span class="info-value"><?php echo e($parcelInfo); ?></span>
            </div>
            <?php endif; ?>
        </div>

        <div class="payment-method payment-method-<?php echo e($payment->forma_pagamento); ?>">
            <strong>💳 Forma de Pagamento: <?php echo e($paymentMethod); ?></strong>
        </div>

        <div class="instructions">
            <h4>📋 Próximos Passos</h4>
            <?php if($payment->mercadopago_data): ?>
                <?php
                ...
                <?php switch($payment->forma_pagamento):
                    case ('pix'): ?>
                        <?php if(isset($mpData['point_of_interaction']['transaction_data']['qr_code'])): ?>
                            <div class="payment-method pix">
                                <h5>🔑 Código PIX</h5>
                                <div class="pix-code">
                                    <code><?php echo e($mpData['point_of_interaction']['transaction_data']['qr_code']); ?></code>
                                </div>
                    ...
                    <?php case ('boleto'): ?>
                        <?php if(isset($mpData['transaction_details']['external_resource_url'])): ?>
                            <div class="payment-method boleto">
                                <h5>🧾 Boleto Bancário</h5>
                                <div class="boleto-link">
                                    <a href="<?php echo e($mpData['transaction_details']['external_resource_url']); ?>" target="_blank" class="btn-payment">
                                        📄 Baixar Boleto PDF
                                    </a>
                                </div>
                                <p><strong>Como pagar:</strong></p>
                    ...
                    <?php case ('cartao_credito'): ?>
                        <?php if(isset($mpData['point_of_interaction']['transaction_data']['ticket_url'])): ?>
                            <div class="payment-method credit-card">
                                <h5>💳 Cartão de Crédito</h5>
                                <div class="card-link">
                                    <a href="<?php echo e($mpData['point_of_interaction']['transaction_data']['ticket_url']); ?>" target="_blank" class="btn-payment">
                                        💳 Pagar com Cartão
                                    </a>
                                </div>
                                <p><strong>Como pagar:</strong></p>
...
</html> <?php /**PATH /home/douglas/Downloads/ec-complete-backup-20250728_105142/ec-complete-backup-20250813_144041/resources/views/emails/payment-created.blade.php ENDPATH**/ ?>