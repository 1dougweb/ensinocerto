...
<div class="container-fluid">
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4><?php echo e($stats['pendentes']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4><?php echo e($stats['aprovados']); ?></h4>
        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nome, email...">
                </div>
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="status" name="status">
                        ...
                        <option value="rejeitado" <?php echo e(request('status') == 'rejeitado' ? 'selected' : ''); ?>>Rejeitado</option>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="modalidade" name="modalidade">
                        ...
                        <option value="Polo Presencial" <?php echo e(request('modalidade') == 'Polo Presencial' ? 'selected' : ''); ?>>Polo Presencial</option>
                        <option value="EaD" <?php echo e(request('modalidade') == 'EaD' ? 'selected' : ''); ?>>EaD</option>
                        <option value="Híbrido" <?php echo e(request('modalidade') == 'Híbrido' ? 'selected' : ''); ?>>Híbrido</option>
                        <option value="Representante" <?php echo e(request('modalidade') == 'Representante' ? 'selected' : ''); ?>>Representante</option>
                    </select>
                </div>
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="estrutura" name="estrutura">
                        <option value="">Todos</option>
                        <option value="1" <?php echo e(request('estrutura') == '1' ? 'selected' : ''); ?>>Sim</option>
                        <option value="0" <?php echo e(request('estrutura') == '0' ? 'selected' : ''); ?>>Não</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.parceiros.index')); ?>" class="btn btn-secondary">
                            <i class="fas fa-times"></i> Limpar
                        </a>
                        <a href="<?php echo e(route('admin.parceiros.exportar')); ?><?php echo e(request()->getQueryString() ? '?' . request()->getQueryString() : ''); ?>" class="btn btn-success">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Lista de Parceiros (<?php echo e($parceiros->total()); ?>)</h5>
            <a href="<?php echo e(route('admin.parceiros.create')); ?>" class="btn btn-primary">
                <i class="fas fa-plus me-1"></i> Novo Parceiro
            </a>
        </div>
        <div class="card-body">
            <?php if($parceiros->count() > 0): ?>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $parceiros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parceiro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <strong><?php echo e($parceiro->nome_completo); ?></strong>
                                        <?php if($parceiro->nome_fantasia): ?>
                                            <br><small class="text-muted"><?php echo e($parceiro->nome_fantasia); ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($parceiro->email); ?></td>
                                    <td>
                                        <?php if($parceiro->whatsapp): ?>
                                            <a href="https://wa.me/55<?php echo e(preg_replace('/\D/', '', $parceiro->whatsapp)); ?>" target="_blank" class="text-success">
                                                <?php echo e($parceiro->whatsapp_formatado); ?>
                                    ...
                                    <td>
                                        <?php switch($parceiro->modalidade_parceria):
                                            ...
                                            <?php case ('Híbrido'): ?>
                                                ...
                                                <?php break; ?>
                                            <?php case ('Representante'): ?>
                                                <span class="badge bg-secondary">Representante</span>
                                                <?php break; ?>
                                            <?php default: ?>
                                                <span class="badge bg-light text-dark"><?php echo e($parceiro->modalidade_parceria ?? '-'); ?></span>
                                        <?php endswitch; ?>
                                    </td>
                                    <td>
                                        <?php if($parceiro->possui_estrutura): ?>
                                            <span class="badge bg-success">Sim</span>
                                        <?php else: ?>
                                            <span class="badge bg-warning">Não</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo $parceiro->status_badge; ?></td>
                                    <td><?php echo e($parceiro->created_at->format('d/m/Y H:i')); ?></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('admin.parceiros.show', $parceiro)); ?>" class="btn btn-sm btn-outline-primary" title="Ver Detalhes">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            
                                                                        <?php if($parceiro->status === 'pendente'): ?>
                                <button type="button" class="btn btn-sm btn-outline-success" onclick="showApproveModal(<?php echo e($parceiro->id); ?>, '<?php echo e($parceiro->nome_completo); ?>')" title="Aprovar">
                                    <i class="fas fa-check"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-danger" onclick="showRejectModal(<?php echo e($parceiro->id); ?>, '<?php echo e($parceiro->nome_completo); ?>')" title="Rejeitar">
                                    <i class="fas fa-times"></i>
                                </button>
                            <?php endif; ?>
                            
                            <?php if($parceiro->status === 'aprovado'): ?>
                                <button type="button" class="btn btn-sm btn-outline-success" onclick="showActivateModal(<?php echo e($parceiro->id); ?>, '<?php echo e($parceiro->nome_completo); ?>')" title="Ativar">
                                    <i class="fas fa-play"></i>
                                </button>
                            <?php endif; ?>
                            
                            <?php if($parceiro->status === 'ativo'): ?>
                                <button type="button" class="btn btn-sm btn-outline-warning" onclick="showDeactivateModal(<?php echo e($parceiro->id); ?>, '<?php echo e($parceiro->nome_completo); ?>')" title="Inativar">
                                    <i class="fas fa-pause"></i>
                                </button>
                            <?php endif; ?>
                                            
                                                                        <?php if($parceiro->whatsapp): ?>
                                <a href="https://wa.me/55<?php echo e(preg_replace('/\D/', '', $parceiro->whatsapp)); ?>" target="_blank" class="btn btn-sm btn-outline-success" title="WhatsApp">
                                    <i class="fab fa-whatsapp"></i>
                                </a>
                            <?php endif; ?>
                                            
                                            <a href="<?php echo e(route('admin.parceiros.edit', $parceiro)); ?>" class="btn btn-sm btn-outline-secondary" title="Editar">
                ...
                <div class="d-flex justify-content-center">
                    <?php echo e($parceiros->appends(request()->query())->links()); ?>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u760830176/domains/ensinocerto.com.br/public_html/resources/views/admin/parceiros/index.blade.php ENDPATH**/ ?>