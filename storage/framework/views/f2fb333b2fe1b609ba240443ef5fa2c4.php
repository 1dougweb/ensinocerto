...
<div class="container-fluid px-4">
    ...
    <form id="matriculaForm" method="POST" action="<?php echo e(route('admin.matriculas.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>

        <?php if($inscricao): ?>
            <input type="hidden" name="inscricao_id" value="<?php echo e($inscricao->id); ?>">
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="nome_completo" 
                                       name="nome_completo" 
                                       value="<?php echo e(old('nome_completo', $inscricao->nome ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="O" <?php echo e(old('sexo') == 'O' ? 'selected' : ''); ?>>Outro</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        name="estado_civil">
                                    <option value="">Selecione</option>
                                    <option value="solteiro" <?php echo e(old('estado_civil') == 'solteiro' ? 'selected' : ''); ?>>Solteiro(a)</option>
                                    ...
                                    <option value="viuvo" <?php echo e(old('estado_civil') == 'viuvo' ? 'selected' : ''); ?>>Viúvo(a)</option>
                                    <option value="outro" <?php echo e(old('estado_civil') == 'outro' ? 'selected' : ''); ?>>Outro</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="nacionalidade" 
                                       name="nacionalidade" 
                                       value="<?php echo e(old('nacionalidade', 'Brasileira')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="naturalidade" 
                                       name="naturalidade" 
                                       value="<?php echo e(old('naturalidade')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="telefone_fixo" 
                                       name="telefone_fixo" 
                                       value="<?php echo e(old('telefone_fixo')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('telefone_celular', $inscricao->telefone ?? '')); ?>" 
                                       placeholder="(00) 00000-0000">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="email" 
                                       name="email" 
                                       value="<?php echo e(old('email', $inscricao->email ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          name="observacoes" 
                                          rows="3" 
                                          placeholder="Digite aqui observações adicionais sobre o aluno..."><?php echo e(old('observacoes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input <?php $__errorArgs = ['escola_parceira'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $formSettings['available_modalities'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('modalidade', $inscricao->modalidade ?? '') == $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        name="curso">
                                    <option value="">Selecione</option>
                                    <?php $__currentLoopData = $formSettings['available_courses'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('curso', $inscricao->curso ?? '') == $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" 
                                       class="form-control <?php $__errorArgs = ['ultima_serie'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="ultima_serie" 
                                       name="ultima_serie" 
                                       value="<?php echo e(old('ultima_serie')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="ano_conclusao" 
                                       name="ano_conclusao" 
                                       value="<?php echo e(old('ano_conclusao')); ?>" 
                                       min="1950" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="escola_origem" 
                                       name="escola_origem" 
                                       value="<?php echo e(old('escola_origem')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                    <option value="">Selecione</option>
                                    <option value="pre_matricula" <?php echo e(old('status', 'pre_matricula') == 'pre_matricula' ? 'selected' : ''); ?>>Pré-Matrícula</option>
                                    <option value="matricula_confirmada" <?php echo e(old('status') == 'matricula_confirmada' ? 'selected' : ''); ?>>Matrícula Confirmada</option>
                                    <option value="cancelada" <?php echo e(old('status') == 'cancelada' ? 'selected' : ''); ?>>Cancelada</option>
                                    <option value="trancada" <?php echo e(old('status') == 'trancada' ? 'selected' : ''); ?>>Trancada</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3 mb-3 campo-dia-vencimento passo-6" style="display: none;">
                                ...
                                <select class="form-select" id="dia_vencimento" name="dia_vencimento">
                                    <option value="">Selecione</option>
                                    <?php for($i = 1; $i <= 31; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(old('dia_vencimento') == $i ? 'selected' : ''); ?>>
                                            Dia <?php echo e($i); ?>
            ...
            <div class="col-12 mt-4">
                <div class="d-flex justify-content-end align-items-center gap-2">
                    <a href="<?php echo e(route('admin.matriculas.index')); ?>" class="btn btn-secondary">
...
<script src="https://unpkg.com/imask"></script>
    ...
    $(document).ready(function() {
        ...
        function loadAvailableFolders() {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.files.list-folders")); ?>',
                method: 'GET',
        ...
        function createParentFolder() {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.files.create-parent-folder")); ?>',
                method: 'POST',
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.files.store")); ?>',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function handleCreateFolder(e) {
            ...
            const url = '<?php echo e(route("admin.files.create-folder")); ?>';
        ...
        function loadFiles() {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.files.index")); ?>',
                method: 'GET',
        ...
        function handleDeleteFile(e) {
            ...
            $.ajax({
                url: '<?php echo e(url("dashboard/files")); ?>/' + fileId,
                method: 'DELETE',
                success: function(response) {
        ...
        function shareWithUser(email, role, notify) {
            ...
            $.ajax({
                url: '<?php echo e(url("dashboard/files")); ?>/' + currentFileId + '/share-user',
                method: 'POST',
                data: {
                    email: email,
                    role: role,
        ...
        function createPublicLink(role) {
            ...
            $.ajax({
                url: '<?php echo e(url("dashboard/files")); ?>/' + currentFileId + '/public-link',
                method: 'POST',
                data: { role: role },
                success: function(response) {
                    if (response.success) {
        ...
        function generateEmbed(width, height) {
            ...
            $.ajax({
                url: '<?php echo e(url("dashboard/files")); ?>/' + currentFileId + '/embed',
                method: 'POST',
                data: {
                    width: width,
                    height: height
        ...
        function loadPermissions() {
            ...
            $.ajax({
                url: '<?php echo e(url("dashboard/files")); ?>/' + currentFileId + '/permissions',
                method: 'GET',
                success: function(response) {
                    if (response.success) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(() => {
                            try {
                                const redirectUrl = response.redirect_url || '<?php echo e(route("admin.matriculas.index")); ?>';
                                console.log('Redirecionando para:', redirectUrl);
                                window.location.href = redirectUrl;
                            } catch (e) {
                                console.error('Erro ao redirecionar:', e);
                                window.location.href = '<?php echo e(route("admin.matriculas.index")); ?>';
                            }
                        }, 2000);
                    } else {
                        // Erro geral
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/douglas/Downloads/ec-complete-backup-20250728_105142/ec-complete-backup-20250813_144041/resources/views/admin/matriculas/create.blade.php ENDPATH**/ ?>